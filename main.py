...
def test_PI(test, policy_opt, values_opt):
...
def test_scot(test, policy_opt, values_opt, seed):
...
def main():
    ...
    test_scot(test, policy_opt, values_opt, seed)


    test_PI(test, policy_opt, values_opt)
